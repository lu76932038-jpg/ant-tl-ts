...
const EntryList: React.FC = () => {
    ...
    const filteredRecords = records.filter(record =>
        ...
        (record.warehouse && record.warehouse.toLowerCase().includes(searchTerm.toLowerCase()))
    );
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="border-b border-gray-100">
                                        ...
                                        <th className="py-5 px-6 text-[13px] font-medium text-gray-400">供应商编码</th>
                                    ...
                                    {isLoading ? (
                                        ...
                                        paginatedRecords.map((record) => (
                                            <tr key={record.id} className="hover:bg-gray-50/50 transition-colors">
                                                ...
                                                <td className="py-5 px-6 text-sm text-gray-600 font-mono">{record.supplier_code || '-'}</td>
